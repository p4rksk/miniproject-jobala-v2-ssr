...
| 이름 | 사진 | 역할 |
| :--: | :--: | :-------------------: |
| 박선규 | <img src="https://github.com/p4rksk/miniproject-jobala-v2-ssr/assets/153582360/cf8fd9c6-50d9-40b5-9914-09527344bf92" width="100"> | (기업, 개인)등록 및 로그인, 회원가입<br>(기업, 개인)커뮤니티 게시판-보기, 글쓰기, 수정, 삭제<br>(기업, 개인)댓글 - 목록보기, 등록, 삭제<br>(기업 스크랩) 인재채용- 목록보기 |
