...
| 이름 | 사진 | 역할 |  
|:--:|:--:|:---------------:|
| 박선규 | <img src="https://avatars.githubusercontent.com/u/153582401?v=4" width="150px"> | (기업, 개인)등록 및 로그인, 회원가입<br/>(기업, 개인)커뮤니티 게시판-보기, 글쓰기, 수정, 삭제<br>(기업, 개인)댓글 - 목록보기, 등록, 삭제<br/>(기업 스크랩) 인재채용- 목록보기<br/단위 테스트|
